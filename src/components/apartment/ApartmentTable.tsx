...
const ApartmentTable = () => {
  ...
  const handleApartmentFunctions = (
    type: ApartmentTableModalTypes,
    apartment = {} as IApartmentRow
  ) => {
  ...
  const handlePerRowsChange = (perPageRows: number) =>
    dispatch({ type: ApartmentActionTypes.UPDATE_PER_PAGE_ROWS, perPageRows });
      ...
      <DataTable
            ...
            cell: (row) => (
              ...
              >
                <Button
                  ...
                  onClick={() =>
                    handleApartmentFunctions(
                      ApartmentTableModalTypes.UPDATE,
                      row
                    )
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    handleApartmentFunctions(
                      ApartmentTableModalTypes.DELETE,
                      row
                    )
                  }
                >
        ...
        subHeaderComponent={
          <ApartmentTableHeader
            handleApartmentFunctions={handleApartmentFunctions}
          />
        }
